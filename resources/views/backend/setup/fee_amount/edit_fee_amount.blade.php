            ...
            <div class="col-12">
                ...
                <div class="box">
                    ...
                    <div class="box-body">
                        ...
                        @endif
                        <form class="form" action="{{route('fee.amount.update', $editData[0]->fee_category_id)}}"
                              method="post">
                            @csrf
                            <div class="box-body">
                                <div class="add_item">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" name="fee_category_id">
                                                    ...
                                                    @foreach($fee_categories as $fee_cat)
                                                        <option
                                                            value="{{$fee_cat->id}}" {{($editData[0]->fee_category_id == $fee_cat->id) ? 'selected' :''}}>{{$fee_cat->name}}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-control" name="class_id[]">
                                                            ...
                                                            @foreach($classes as $class)
                                                                <option
                                                                    value="{{$class->id}}" {{($row->class_id == $class->id) ? 'selected' :''}}>{{$class->name}}</option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                                                </div>
